    ...
    <div className="border rounded-xl bg-muted/30 p-8 md:p-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 justify-center">
        ...
        <div className="space-y-3 max-w-xs">
          <p className="text-sm font-medium text-blue-500">Viewport 영역</p>
  ...
  return (
    <div className="border rounded-xl bg-muted/30 p-8 md:p-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 justify-center">
        ...
        <div className="space-y-3 max-w-xs">
          <p className="text-sm font-medium">렌더 전 높이 확보</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
  ...
  return (
    <div className="border rounded-xl bg-muted/30 p-8 md:p-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 justify-center">
        ...
        <div className="space-y-3 max-w-xs">
          <p className="text-sm font-medium">GroupWrapper + Separator</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
  ...
  return (
    <div className="border rounded-xl bg-muted/30 p-8 md:p-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 justify-center">
        ...
        <div className="space-y-3 max-w-xs">
          <p className="text-sm font-medium">가드 Ref로 위치 보존</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
  ...
  return (
    <div className="border rounded-xl bg-muted/30 p-8 md:p-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 justify-center">
        ...
        <div className="space-y-3 max-w-xs">
          <p className="text-sm font-medium">부분 로딩 윈도우</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
    ...
    <section id="how-it-works" className="space-y-24 [word-break:keep-all]">
      ...
      <article id="virtual-scroll" className="space-y-8">
        <div className="space-y-3">
          ...
          <h3 className="text-2xl font-bold tracking-tight">사전 렌더링 기반 가상 스크롤</h3>
        </div>
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">가상 스크롤이란?</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">이진 탐색으로 첫 번째 아이템 찾기</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div id="pre-render-measurement" className="space-y-3">
          <p className="text-sm font-medium">사전 높이 측정</p>
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">높이 잠금 (Height Locking)</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <article id="sticky-group-header" className="space-y-8">
        <div className="space-y-3">
          ...
          <h3 className="text-2xl font-bold tracking-tight">Sticky Group Header</h3>
        </div>
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">왜 이중 구조인가?</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border rounded-lg p-5 space-y-2">
              <p className="text-sm font-medium">Separator (구분선)</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">sticky 착지 효과</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">GroupWrapper의 height 계산</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <article id="bidirectional-scroll" className="space-y-8">
        <div className="space-y-3">
          ...
          <h3 className="text-2xl font-bold tracking-tight">양방향 무한 스크롤</h3>
          <p className="text-base text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">해결: 방향별 가드 ref + totalHeight effect</p>
          <GuardRefFlowDiagram />
        </div>

        <div className="space-y-3">
          <p className="text-sm font-medium">가드 ref의 생명주기</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border rounded-lg p-5 space-y-2">
      ...
      <article id="chat-app-patterns" className="space-y-8">
        <div className="space-y-3">
          ...
          <h3 className="text-2xl font-bold tracking-tight">Chat App Patterns</h3>
          <p className="text-base text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">패턴 1: 마지막 읽은 메시지에서 열기</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">패턴 2: 메시지 전송 시 분기</p>
          <SendMessageDiagram />
        </div>

        <div className="space-y-3">
          <p className="text-sm font-medium">패턴 3: 메시지 이동 (로드된 vs 로드 안된)</p>
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">큐잉 로직이란?</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="border rounded-lg bg-muted/30 p-4 text-xs font-mono leading-relaxed space-y-1 overflow-x-auto">
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium">라이브러리 vs 소비자 책임</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border rounded-lg p-5 space-y-2">
